...
<div class="main-header">
    ...
    <p>Tác giả: Bàn Thị Phấn - Trường TH Vĩnh Hảo - ĐT: 0962 219 618</p>
</div>
""", unsafe_allow_html=True)
...
# --- CHÂN TRANG ---
st.markdown("---")
st.markdown("<div style='text-align: center; color: #666;'>© 2025 - Bàn Thị Phấn - Trường TH Vĩnh Hảo - ĐT: 0962 219 618</div>", unsafe_allow_html=True)
